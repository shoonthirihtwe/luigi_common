...
public class Luigi2CodeContractLog {
   ...
   * 事由種別（大分類）
   * 
   * 01:契約取消／契約解除 02:名義住所変更 05:保険料請求 09:受取人変更 14:契約成立 20:解約 24:自動更新 28:契約満了 31:払込経路変更 39:失効
   * 51:保険金等支払
   * 
   * @author : [AOT] s.paku
   * @createdAt : 2021-08-12
   ...
   * 事由種別（大分類）
   * 
   * 010:新契 020:保全 030:請収 050:更新 120:経理
   * 
   * @author : [AOT] g.kim
   * @createdAt : 2021-08-12
   * @updatedAt : 2021-08-12
   ...
   * 異動コード
   * 
   * 01:経理:保険金（給付金）支払 06:成立確定 11:保険料収納 21:保険料未納 24:契約満了 更新 25:契約満了 保険料変更 28:契約満了 満了 90:失効
   * 
   * @author : [AOT] g.kim
   * @createdAt : 2021-08-12
   * @updatedAt : 2021-08-12
